...
const NavBar = ({ isAuth }) => {
  return (
    ...
    >
      ...
      <div className={`w-3/6 navbar-start  `}>
      ...
      <div className=" md:gap-2 navbar-end">
        <div className="flex items-center px-3 py-1 rounded-md hover:border focus:border">
          <input
            type="text"
            id="search"
            className={`w-28 focus:outline-none ${
              isAuth ? "bg-[#4A154b] text-white" : "bg-white text-black"
            } font-normal`}
          />
